...
function ScheduleForm() {
  ...
  function handleLessonDurationChange(e) {
    setForm({ ...form, lesson_duration: e.target.value });
  }
  ...
  return (
    <>
      ...
      <h4>Please fill out the form below. You will receive a response from Coach Brett within 24 hours.</h4>
      <Form onSubmit={handleSubmit}>
        ...
        <Form.Group className="mb-3">
          <Dropdown onSelect={handleLessonDurationChange}>
            <Dropdown.Toggle 
            variant="primary"
            style={{ backgroundColor: "#003f85", border: "none", color: "white" }}
            >{lessonDuration || "Choose how long you want to train"}</Dropdown.Toggle>
            <Dropdown.Menu>
                <Dropdown.Item disabled>*Choose how long you want to train</Dropdown.Item>
        ...
        <Form.Group className="mb-3">
          <Form.Label>Tell us what you are looking for your athlete.</Form.Label>
          <Form.Control
            name="request"
            as="textarea"
            required
